...
const UserProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Only send fields that have values and are different from current
    const updateData = {};
    ...
    if (Object.keys(updateData).length === 0) {
      setError('No changes to save. Please update at least one field.');
      setIsLoading(false);
      return;
    }
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Update your account information and preferences</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="profile-actions">
            ...
            <Link to="/contacts" className="profile-cancel-link">
